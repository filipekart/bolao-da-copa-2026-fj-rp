      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 flex-1 min-w-0">
          {match.home_team_flag_url && (
            <Flag src={match.home_team_flag_url} alt="" className="w-6 h-4 rounded-sm object-cover" />
          )}
        ...
        <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
          ...
          {match.away_team_flag_url && (
            <Flag src={match.away_team_flag_url} alt="" className="w-6 h-4 rounded-sm object-cover" />
          )}
        </div>
      </div>
